...
tags equal the CMAC recomputed by the independent Python AES, the key is
the first half of the generator's output, and two generations give
different keys. This is the first point at which a key born from
